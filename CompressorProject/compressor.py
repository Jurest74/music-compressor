...
def extract_audio_to_wav(input_cda, output_mp3, bitrate='192k'):
    print(input_cda, output_mp3)
...
def main():
    ...
    #hilo_wav = threading.Thread(target=extract_audio_to_wav(full_path, output_mp3))
